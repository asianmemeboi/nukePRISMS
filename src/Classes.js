...
class Class extends React.Component {
  ...
  render() {
    return (
      ...
      <div className={"class-card " + this.state.subject} id={this.state.id} style={{height: "12vh", background: "blue", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}}>
